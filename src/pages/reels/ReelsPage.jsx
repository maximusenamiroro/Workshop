...
export default function ReelsPage() {
  ...
  return (
    <div
      className="h-[100dvh] w-full overflow-y-auto bg-black snap-y snap-mandatory scroll-smooth"
      style={{
    ...
    >
      {reels.map((reel) => (
        <div
          key={reel.id}
          className="h-[100dvh] w-full flex-shrink-0 snap-start relative bg-black overflow-hidden"
        >
          <Suspense fallback={<div className="h-full w-full bg-black flex items-center justify-center"><div className="w-10 h-10 border-4 border-green-500 border-t-transparent rounded-full animate-spin" /></div>}>
